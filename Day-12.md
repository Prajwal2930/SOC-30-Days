...
## 🎯 **Objective:**  
The objective of this lab is to help to understand the **core steps of incident response** by investigating a **suspicious bash script execution** on a Linux system. we will learn how to detect, analyze, and respond to a basic script-based intrusion.
...
- [x] **LinkedIn Post:** [View My Post Here](https://www.linkedin.com/posts/prajwal-kunte-008869313_cybersecurity-socanalyst-incidentresponse-activity-7353762224429051904-BAfZ?utm_source=share&utm_medium=member_desktop&rcm=ACoAAE-u8sgBVqzP55c4GvPwfw20YNMFfe4EJ7U)